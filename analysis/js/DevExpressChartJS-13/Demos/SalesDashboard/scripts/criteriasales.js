SalesDashboard.criteriaSalesModel = function () {
    var self = this,
        ...
        'Asia': { color: SalesDashboard.getColor("", 0), letter: 'A' },
        'Australia': { color: SalesDashboard.getColor("", 1), letter: 'B' },
        'Europe': { color: SalesDashboard.getColor("", 2), letter: 'C' },
        'North America': { color: SalesDashboard.getColor("", 3), letter: 'D' },
        'South America': { color: SalesDashboard.getColor("", 4), letter: 'E' },
